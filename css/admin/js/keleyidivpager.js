...
var kkpager = {
    ...
    generPageHtml: function () {
        ...
        if (this.hasPrv) {
            str_prv = '<ul class="paginList"><li class="paginItem"><a href="' + this.getLink(this.prv) + '" title="上一页"><span class="pagepre"></span></a></li>';
        } else {
            str_prv = '<ul class="paginList"><li class="paginItem"><a><span class="pagepre"></span></a></li>';
        }
        if (this.hasNext) {
            str_next = '<li class="paginItem"><a href="' + this.getLink(this.next) + '" title="下一页"><span class="pagenxt"></span></a></li></ul>';
        } else {
            str_next = '<li class="paginItem"><a><span class="pagenxt"></span></a></li></ul>';
        }


        var str = '';
        var dot = '<li class="paginItem more"><a>...</a></li>';
        var total_info = '';
        if (this.isShowTotalPage || this.isShowTotalRecords) {
            total_info = '<div class="message" style="float:left">共<i class="blue">';
            if (this.isShowTotalPage) {
                total_info += this.total + '</i>页';
                if (this.isShowTotalRecords) {
                    total_info += '&nbsp;/&nbsp;<i class="blue">';
                }
            }
            if (this.isShowTotalRecords) {
                total_info += this.totalRecords + '</i>条数据';
            }
        ...
        if (this.total <= 8) {
            for (var i = 1; i <= this.total; i++) {
                if (this.pno == i) {
                    str += '<li class="paginItem current"><a>' + i + '</a></li>';
                } else {
                    str += '<li class="paginItem"><a href="' + this.getLink(i) + '" title="第' + i + '页">' + i + '</a></li>';
                }
            }
        } else {
            if (this.pno <= 5) {
                ...
                str += '<li class="paginItem"><a href="' + this.getLink(1) + '" title="第1页">1</a></li>';
                str += '<li class="paginItem"><a href="' + this.getLink(2) + '" title="第2页">2</a></li>';
                str += dot;
