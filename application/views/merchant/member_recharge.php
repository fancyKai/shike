...
<section id="section">
    ...
    <div class="rechange_details">
        ...
        <div class="member_rechange">
            <h1>请选择开通时长</h1>
            <ul style="padding-bottom:5px;" class="select_duration">
                <li class="select one_years" onclick="change_recharge_items(1)">
                            <p><span>&yen;1288.00</span></p>
                             <p>会员时长：<b>1年</b></p
                         </li>
                         <li class="select two_years" onclick="change_recharge_items(2)">
                          <p><span>&yen;4576.00</span></p>
                             <p>会员时长：<b>2年</b></p>
                         </li>
                         <li class="select three_years" onclick="change_recharge_items(3)">
                          <p><span>&yen;6864.00</span></p>
                             <p>会员时长：<b>3年</b></p>
                         </li>
            </ul>
             <p style="padding-left:50px;color:#f10180; padding-bottom:20px;font-size:14px;font-weight:bold;">限时优惠，仅限前100名</p>
            <div class="need_pay">
                <p class="one">您已选择<b>1</b>年会员，有效期至<b><?php echo $one_year_end;?></b></p>
                <p class="two">需要支付:<span>&yen;1288.00</span></p>
                <p class="three" style = "display:none;padding-bottom: 8px">您已选择<b style="color: #f10180;">2</b>年会员，有效期至<b style="color: #f10180;"><?php echo $two_year_end;?></b></p>
                <p class="four" style = "display:none">需要支付:<span style="font-size: 24px;    margin-left: 10px;
  color: #e61e28;">&yen;4576.00</span></p>
                <p class="five" style = "display:none;padding-bottom: 8px">您已选择<b style="color: #f10180;">3</b>年会员，有效期至<b style="color: #f10180;"><?php echo $three_year_end;?></b></p>
                <p class="six" style = "display:none">需要支付:<span style="font-size: 24px;    margin-left: 10px;
  color: #e61e28;">&yen;6864.00</span></p>
            </div>
            <h1>请选择银行</h1>
            <table>
                <tr>
...
<script>
    ...
    function pay_recharge(){
        ...
        {
            money = 128800;
        }else if(recharge_year == 2)
        {
            money = 457600;
        }else if(recharge_year == 3)
        {
            money = 686400;
        }
        window.open("http://www.shike8888.com/kq/send?money="+money+"&bankId="+bankId+"&ext1=2&ext2="+recharge_year);
        // $.ajax({
    ...
    function pay_check(){
        ...
        $.ajax({
        url : admin.url+'Merchant_member_recharge/pay_check',
        type : 'POST',
        cache : false,
        dataType:'json',
    ...
    function check_fail(){
        window.location.href="/Merchant_member_manage";
    }
