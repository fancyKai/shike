    ...
    <div class="login_content">
        <div class="login_box right">
            ...
            <div class="forget_password">
                ...
                <span>/</span>
                <span>联系客服：</span>
                <a href="#"><img src="images/shike/login_button_QQ_default.png" alt="" onclick="window.open('http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq;?>&site=qq&menu=yes')"></a>
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    function login(){
        ...
        if(name === '' || password === ''){
            ...
            $.ajax({
                url : 'merchant_login/check_login',
                type : "POST",
                datatype : "json",
                cache : false,
                timeout : 20000,
