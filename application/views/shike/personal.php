            ...
            <div class="task_specification">
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0201_waitGet_details.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                            ...
                            <li>
                                <p class="place_order"><input onclick="location.href='../02_try_manage/getOrders_stepOne.html'" type="button" value="领取下单"/></p>
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0202_wait_deliverGoods.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                            ...
                            <li>
                                ...
                                <p class="two"><span>店铺：夏季尼官方旗舰店</span></p>
                                <p>来源：<span>淘宝</span></p>
                            </li>
                            <li>
                                <p>待发货</p>
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0203_wait_receiving_detail.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                            ...
                            <li>
                                <p class="btn"><input onclick="location.href='../02_try_manage/preliminary_evaluation.html'" type="button" value="初步评价"/></p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0204_wait_audit_detail.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0205_wait_cloneEvaluate_detail.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                            ...
                            <li>
                                <p class="btn" id="audit"><input onclick="location.href='../02_try_manage/taobao_evaluation.html'"  type="button" value="淘宝评价"/></p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0206_wait_confirmEvaluate_detail.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0207_finish_detail.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
                ...
                <div class="delivery_status">
                    <div class="title">
                        ...
                        <p class="right">
                            <a href="../02_try_manage/0208_canceled_details.html">查看详情</a>
                        </p>
                    </div>
                    <div class="detalis">
                        <ul>
