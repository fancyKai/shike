        ...
        <div class="message_notification left">
            ...
            <?php foreach($messages as $v):?>
                <tr>
                    ...
                    <td style="font-weight:bold"><a href="/shike_message_details?message_id=<?php echo $v['message_id'];?>">查看详情</a></td>
                    <?php else:?>
                    <td><?php echo substr($v['message_time'],0,10);?></td>
                    <td><?php echo $v['title'];?></td>
                    <td><a href="/shike_message_details?message_id=<?php echo $v['message_id'];?>">查看详情</a></td>
                    <?php endif;?>
                </tr>
            <?php endforeach ?>
            </table>
