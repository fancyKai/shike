...
<head>
    ...
    <link rel="stylesheet" href="css/shike/deposit_withdraw.css">
</head>
<body>
        ...
        <div class="deposit_withdraw left">
            ...
            <div class="fillIn_money">
                ...
                <?php if(!$bankcard):?>
                    <div class="left bankCard_two">
                        <p><img onclick="location.href='/shike_add_bankCard'" src="images/shike/sj_zjgl_icon_bdyhk_default.png" alt=""></p>
                        <p>请先绑定银行卡</p>
                    </div>
                <?php else:?>
                    <div class="left bankCard_one">
                        <p class="one"><img src="images/shike/sj_zhxx_bg_bdyhk_nyyh_five_default.png" alt=""></p>
                ...
                <div class="main_five">
                    ...
                    <br/>
                    <p class="one">忘记密码请联系客服：<img src="images/shike/sj_grzx_icon_qq_default.png" alt="" onclick="window.open('http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq;?>&site=qq&menu=yes')"></p>
                </div>
            </div>
            <p class="confirm_btn">
            ...
            <div class="warm_prompt">
                ...
                <p>
                    ...
                    <img src="images/shike/sj_grzx_icon_qq_default.png" alt="" onclick="window.open('http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq;?>&site=qq&menu=yes')">
                </p>
            </div>
        </div>
    </div>
...
<script>
    $(function(){
        ...
        //     $('.fund_manage ul>li').find('a').eq(0).addClass('left_nav_active');
        // });
